...
def start_game():
    ...
    while not game_over:
        ...
        if turn == AI and not game_over:                
            ...
            col, minimaxWithPrunning_score = minimax(board, 5, -math.inf, math.inf, True)
...
def main_menu():
    ...
    while menu:
        ...
        if selected=="choice1":
            text_start=text_format("computer 'pruning' vs AI", font, 75, white)
        else:
            text_start = text_format("computer 'pruning' vs AI", font, 75, black)
        if selected=="choice2":
            text_quit=text_format("computer 'no pruning' vs AI", font, 75, white)
        else:
            text_quit = text_format("computer 'no pruning' vs AI", font, 75, black)
